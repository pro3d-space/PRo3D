...
% Test case counter
\newcounter{testcase}
\newcommand{\testid}{\stepcounter{testcase}TC-\arabic{testcase}}
...
\midrule
\endhead
TC-01 & Start PRo3D & \checkbox~Pass / \checkbox~Fail & \\
TC-02 & Add Surface (OPC) & \checkbox~Pass / \checkbox~Fail & \\
TC-03 & Surface FlyTo & \checkbox~Pass / \checkbox~Fail & \\
TC-04 & Save Scene & \checkbox~Pass / \checkbox~Fail & \\
TC-05 & Load Scene (Open) & \checkbox~Pass / \checkbox~Fail & \\
TC-06 & Load Scene (Recent) & \checkbox~Pass / \checkbox~Fail & \\
TC-07 & FreeFly Navigation & \checkbox~Pass / \checkbox~Fail & \\
TC-08 & ArcBall Navigation & \checkbox~Pass / \checkbox~Fail & \\
TC-09 & Pick Explore Center & \checkbox~Pass / \checkbox~Fail & \\
TC-10 & Place Coordinate System & \checkbox~Pass / \checkbox~Fail & \\
TC-11 & Draw Point Annotation & \checkbox~Pass / \checkbox~Fail & \\
TC-12 & Draw Line Annotation & \checkbox~Pass / \checkbox~Fail & \\
TC-13 & Draw Polyline Annotation & \checkbox~Pass / \checkbox~Fail & \\
TC-14 & Draw Polygon Annotation & \checkbox~Pass / \checkbox~Fail & \\
TC-15 & Draw Dip and Strike Annotation & \checkbox~Pass / \checkbox~Fail & \\
TC-16 & Annotation Projection Modes & \checkbox~Pass / \checkbox~Fail & \\
TC-17 & Pick Annotation (via UI list) & \checkbox~Pass / \checkbox~Fail & \\
TC-18 & Pick Annotation (via 3D view) & \checkbox~Pass / \checkbox~Fail & \\
TC-19 & Pick Surface (via UI list) & \checkbox~Pass / \checkbox~Fail & \\
TC-20 & Pick Surface (via 3D view) & \checkbox~Pass / \checkbox~Fail & \\
TC-21 & Surface Properties Panel & \checkbox~Pass / \checkbox~Fail & \\
TC-22 & Surface Visibility Toggle & \checkbox~Pass / \checkbox~Fail & \\
TC-23 & Surface Color Correction & \checkbox~Pass / \checkbox~Fail & \\
TC-24 & Surface Translation & \checkbox~Pass / \checkbox~Fail & \\
TC-25 & Surface FillMode (Wireframe) & \checkbox~Pass / \checkbox~Fail & \\
TC-26 & Annotation Properties Panel & \checkbox~Pass / \checkbox~Fail & \\
TC-27 & Annotation Measurements & \checkbox~Pass / \checkbox~Fail & \\
TC-28 & Annotation Text Note & \checkbox~Pass / \checkbox~Fail & \\
TC-29 & Place Scalebar & \checkbox~Pass / \checkbox~Fail & \\
TC-30 & Scalebar Properties & \checkbox~Pass / \checkbox~Fail & \\
TC-31 & Add Bookmark & \checkbox~Pass / \checkbox~Fail & \\
TC-32 & Bookmark FlyTo & \checkbox~Pass / \checkbox~Fail & \\
TC-33 & Sequenced Bookmarks -- Add \& Animate & \checkbox~Pass / \checkbox~Fail & \\
TC-34 & Sequenced Bookmarks -- Record \& Render & \checkbox~Pass / \checkbox~Fail & \\
TC-35 & Viewer Config Settings & \checkbox~Pass / \checkbox~Fail & \\
TC-36 & Screenshots & \checkbox~Pass / \checkbox~Fail & \\
TC-37 & Grouping -- Create Group & \checkbox~Pass / \checkbox~Fail & \\
TC-38 & Grouping -- Move Leafs & \checkbox~Pass / \checkbox~Fail & \\
TC-39 & View Planner -- Place Rover & \checkbox~Pass / \checkbox~Fail & \\
TC-40 & View Planner -- Instrument View & \checkbox~Pass / \checkbox~Fail & \\
TC-41 & GIS View -- Load SPICE Kernel & \checkbox~Pass / \checkbox~Fail & \\
TC-42 & GIS View -- Observation Settings & \checkbox~Pass / \checkbox~Fail & \\
TC-43 & Contour Lines & \checkbox~Pass / \checkbox~Fail & \\
TC-44 & Multitexturing & \checkbox~Pass / \checkbox~Fail & \\
TC-45 & Surface Comparison -- Activate Mode & \checkbox~Pass / \checkbox~Fail & \\
TC-46 & Surface Comparison -- Select Area & \checkbox~Pass / \checkbox~Fail & \\
TC-47 & Surface Comparison -- Surface Measurements & \checkbox~Pass / \checkbox~Fail & \\
TC-48 & Surface Comparison -- Length Measurements & \checkbox~Pass / \checkbox~Fail & \\
TC-49 & Minerva -- Load Data \& Listing & \checkbox~Pass / \checkbox~Fail & \\
TC-50 & Minerva -- Query App Filter & \checkbox~Pass / \checkbox~Fail & \\
TC-51 & Minerva -- Product Selection & \checkbox~Pass / \checkbox~Fail & \\
TC-52 & Minerva -- Pick Linking & \checkbox~Pass / \checkbox~Fail & \\
TC-53 & CLI -- Snapshot Rendering & \checkbox~Pass / \checkbox~Fail & \\
TC-54 & RIMFAX -- Load Traverse & \checkbox~Pass / \checkbox~Fail & \\
TC-55 & RIMFAX -- Load Surfaces & \checkbox~Pass / \checkbox~Fail & \\
TC-56 & Keyboard Shortcuts & \checkbox~Pass / \checkbox~Fail & \\
\bottomrule
\end{longtable}
...
%--- TC-02 ---
\subsection{TC-02: Add Surface (OPC)}
\label{tc:02}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & PRo3D is running (TC-01 passed). An OPC surface folder is available on disk. \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-03 ---
\subsection{TC-03: Surface FlyTo}
\label{tc:03}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface has been loaded (TC-02 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-04 ---
\subsection{TC-04: Save Scene}
\label{tc:04}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & At least one surface is loaded (TC-02 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
    \item Click the main menu icon in the top-left corner.
...
%--- TC-05 ---
\subsection{TC-05: Load Scene (Open)}
\label{tc:05}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A scene file (\texttt{.scn}) exists on disk (TC-04 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-06 ---
\subsection{TC-06: Load Scene (Recent)}
\label{tc:06}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A scene has been opened at least once before (TC-05 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
    \item Click the main menu icon in the top-left.
...
%--- TC-07 ---
\subsection{TC-07: FreeFly Navigation}
\label{tc:07}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface is loaded and visible in the 3D view (TC-03 passed). The navigation mode is set to FreeFly. \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-08 ---
\subsection{TC-08: ArcBall Navigation}
\label{tc:08}
...
%--- TC-09 ---
\subsection{TC-09: Pick Explore Center}
\label{tc:09}
...
%--- TC-10 ---
\subsection{TC-10: Place Coordinate System}
\label{tc:10}
...
%--- TC-11 ---
\subsection{TC-11: Draw Point Annotation}
\label{tc:11}
...
%--- TC-12 ---
\subsection{TC-12: Draw Line Annotation}
\label{tc:12}
...
%--- TC-13 ---
\subsection{TC-13: Draw Polyline Annotation}
\label{tc:13}
...
%--- TC-14 ---
\subsection{TC-14: Draw Polygon Annotation}
\label{tc:14}
...
%--- TC-15 ---
\subsection{TC-15: Draw Dip and Strike (DnS) Annotation}
\label{tc:15}
...
%--- TC-16 ---
\subsection{TC-16: Annotation Projection Modes}
\label{tc:16}
...
%--- TC-17 ---
\subsection{TC-17: Pick Annotation (via UI List)}
\label{tc:17}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & At least one annotation exists (TC-11 through TC-15 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-18 ---
\subsection{TC-18: Pick Annotation (via 3D View)}
\label{tc:18}
...
%--- TC-19 ---
\subsection{TC-19: Pick Surface (via UI List)}
\label{tc:19}
...
%--- TC-20 ---
\subsection{TC-20: Pick Surface (via 3D View)}
\label{tc:20}
...
%--- TC-21 ---
\subsection{TC-21: Surface Properties Panel}
\label{tc:21}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface is selected (TC-19 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-22 ---
\subsection{TC-22: Surface Visibility Toggle}
\label{tc:22}
...
%--- TC-23 ---
\subsection{TC-23: Surface Color Correction}
\label{tc:23}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface is selected and visible (TC-19 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-24 ---
\subsection{TC-24: Surface Translation}
\label{tc:24}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface is selected and a Coordinate System has been placed (TC-10 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-25 ---
\subsection{TC-25: Surface FillMode (Wireframe)}
\label{tc:25}
...
%--- TC-26 ---
\subsection{TC-26: Annotation Properties Panel}
\label{tc:26}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A line or polyline annotation is selected (TC-17 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-27 ---
\subsection{TC-27: Annotation Measurements}
\label{tc:27}
...
%--- TC-28 ---
\subsection{TC-28: Annotation Text Note}
\label{tc:28}
...
%--- TC-29 ---
\subsection{TC-29: Place Scalebar}
\label{tc:29}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A surface is loaded. A coordinate system has been placed (TC-10 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-30 ---
\subsection{TC-30: Scalebar Properties}
\label{tc:30}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A scalebar exists (TC-29 passed) and is selected. \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-32 ---
\subsection{TC-32: Bookmark FlyTo}
\label{tc:32}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & At least one bookmark exists (TC-31 passed). Move the camera to a different viewpoint. \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-33 ---
\subsection{TC-33: Sequenced Bookmarks -- Add and Animate}
\label{tc:33}
...
%--- TC-34 ---
\subsection{TC-34: Sequenced Bookmarks -- Record and Generate Images}
\label{tc:34}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & At least two sequenced bookmarks exist (TC-33 passed). An output path is set in the Snapshots section (E). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-35 ---
\subsection{TC-35: Viewer Config Settings}
\label{tc:35}
...
%--- TC-37 ---
\subsection{TC-37: Grouping -- Create Group}
\label{tc:37}
...
%--- TC-38 ---
\subsection{TC-38: Grouping -- Move Leafs}
\label{tc:38}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & At least two annotations exist, and a group has been created (TC-37 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-39 ---
\subsection{TC-39: View Planner -- Place Rover}
\label{tc:39}
...
%--- TC-40 ---
\subsection{TC-40: View Planner -- Instrument View}
\label{tc:40}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A rover has been placed (TC-39 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-41 ---
\subsection{TC-41: GIS View -- Load SPICE Kernel}
\label{tc:41}
...
%--- TC-42 ---
\subsection{TC-42: GIS View -- Observation Settings}
\label{tc:42}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A SPICE kernel is loaded (TC-41 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-43 ---
\subsection{TC-43: Contour Lines}
\label{tc:43}
...
%--- TC-44 ---
\subsection{TC-44: Multitexturing}
\label{tc:44}
...
%--- TC-45 ---
\subsection{TC-45: Surface Comparison -- Activate Mode}
\label{tc:45}
...
%--- TC-46 ---
\subsection{TC-46: Surface Comparison -- Select Area}
\label{tc:46}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & Surface Comparison mode is active and two surfaces are selected (TC-45 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-47 ---
\subsection{TC-47: Surface Comparison -- Surface Measurements}
\label{tc:47}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & Two surfaces are selected in the Comparison tab (TC-45 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-48 ---
\subsection{TC-48: Surface Comparison -- Length Measurements via Bookmarks}
\label{tc:48}
...
%--- TC-49 ---
\subsection{TC-49: Minerva -- Load Data and Product Listing}
\label{tc:49}
...
%--- TC-50 ---
\subsection{TC-50: Minerva -- Query App Filter}
\label{tc:50}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & Minerva data is loaded (TC-49 passed). \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-51 ---
\subsection{TC-51: Minerva -- Product Selection}
\label{tc:51}
...
%--- TC-52 ---
\subsection{TC-52: Minerva -- Pick Linking}
\label{tc:52}
...
%--- TC-53 ---
\subsection{TC-53: CLI -- Snapshot Rendering}
\label{tc:53}
...
\begin{enumerate}[leftmargin=*, nosep]
    ...
    \item Run the basic snapshot command:
    \begin{verbatim}
PRo3D.Snapshots.exe --opcs MyOPCs\surface\
  --asnap snapshots.json --out MyImages\
    \end{verbatim}
...
%--- TC-54 ---
\subsection{TC-54: RIMFAX -- Load Traverse}
\label{tc:54}
...
%--- TC-55 ---
\subsection{TC-55: RIMFAX -- Load Surfaces}
\label{tc:55}

\begin{tabularx}{\textwidth}{lX}
\toprule
\textbf{Prerequisites} & A RIMFAX traverse is loaded (TC-54 passed). The full RIMFAX folder structure (with OBJ/PNG files) is available. \\
\midrule
\textbf{Steps} &
\begin{enumerate}[leftmargin=*, nosep]
...
%--- TC-56 ---
\subsection{TC-56: Keyboard Shortcuts}
\label{tc:56}
