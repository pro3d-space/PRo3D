...
\furtherreading{\onlinedoc{Installation.md}{Installation.md} --- a step-by-step guide for
getting PRo3D onto a Windows, macOS or Linux machine, downloading the test datasets used
throughout this manual (Dimorphos and the MSL Stimson outcrop) and installing the
\texttt{pro3d-tool} command line companion.}
\begin{figure}[h]
    	\centering
