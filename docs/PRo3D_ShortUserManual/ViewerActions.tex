...
\furtherreading{\onlinedoc{ToolStrip.md}{ToolStrip.md} --- the icon rail on the right edge
of the render view, which offers the same actions without leaving the 3D view;
\onlinedoc{DirectToolMode.md}{DirectToolMode.md} --- picking without holding CTRL.}
%----------------------------------------------------------------------------------------
...
\furtherreading{\onlinedoc{Navigation.md}{Navigation.md} --- how the camera works, which
frame it lives in and all navigation settings;
\onlinedoc{MapView.md}{MapView.md} --- the map-like third navigation mode next to FreeFly
and ArcBall; \onlinedoc{NavigationGizmo.md}{NavigationGizmo.md} --- the orientation gizmo
in the lower-left corner of the render view.}
%----------------------------------------------------------------------------------------
...
\furtherreading{\onlinedoc{AnnotationToolbar.md}{AnnotationToolbar.md} --- the in-view
toolbar that appears while ``DrawAnnotation'' is active;
\onlinedoc{AdvancedAnnotations.md}{AdvancedAnnotations.md} --- preview picking and the
advanced picking options; \onlinedoc{AnnotationVertexEditing.md}{AnnotationVertexEditing.md}
--- moving the individual points of an annotation after it has been drawn;
\onlinedoc{EllipseAnnotations.md}{EllipseAnnotations.md} --- the two ellipse geometry types
(see also Section~\ref{sec:ellipseAnnotations}).}
