...
\begin{itemize}
	...
	Pick two points with CTRL+LMB to define the \textbf{major axis} endpoints, then pick a third point to set the \textbf{semi-minor radius} as a perpendicular distance from the major axis.
