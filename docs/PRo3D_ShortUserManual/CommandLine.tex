...
\furtherreading{\onlinedoc{Pro3DTool.md}{Pro3DTool.md} --- \texttt{pro3d-tool}, PRo3D's
separate command line companion, and its subcommands:
\onlinedoc{Pro3DTool-KdTree.md}{kd-tree building},
\onlinedoc{Pro3DTool-SimulateImage.md}{image simulation},
\onlinedoc{Pro3DTool-SunAngles.md}{sun angles} and
\onlinedoc{Pro3DTool-Unproject.md}{unprojection};
\onlinedoc{Installation.md}{Installation.md} --- how to install it;
\onlinedoc{ProvenanceTracking.md}{ProvenanceTracking.md} --- the provenance tracking
features and the command line arguments that enable them.}
