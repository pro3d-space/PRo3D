...
This manual gives an overview of the viewer. In addition, the PRo3D repository carries a
\docsfolder{documentation folder} with one in-depth page per feature, which is kept up to
date with the development of PRo3D and therefore usually covers newer features before this
manual does. Throughout the manual, \textit{Further reading} notes link to the page that
belongs to the section at hand.

\furtherreading{\onlinedoc{Installation.md}{Installation.md} --- installing PRo3D, getting test data and the \texttt{pro3d-tool} command line companion.}
%----------------------------------------------------------------------------------------
%	SubSection: Data
%----------------------------------------------------------------------------------------
\subsection{Data}
