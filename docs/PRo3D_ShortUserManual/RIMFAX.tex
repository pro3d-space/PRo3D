...
\furtherreading{\onlinedoc{RIMFAXTraverse.md}{RIMFAXTraverse.md} --- loading and working
with RIMFAX traverses; \onlinedoc{TraverseLabels.md}{TraverseLabels.md} --- the sol labels
shown next to the waypoints; \onlinedoc{TraversePriorities.md}{TraversePriorities.md} ---
rendering priorities for traverses.}
