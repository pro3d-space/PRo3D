...
It is possible to project images that were captured with Spacecraft instruments onto celestial bodies. Metadata is needed for the projection, which is stored in a json file with the image name and the suffix .mbi, i.e. <image\_name>.mbi.json. It stores information about the instrument, the time and the target body. The .mbi file should contain at least the following fields:
...
A second json file with the format <image\_name>.json contains information about the image. We require this file to store information about the number of channels and the minimum and maximum pixel values that were used to capture the image.   

The images captured with the Hera instruments can be loaded using the main menu or the \textit{Projected Images} tab in the Gis panel, as shown in Figure \ref{fig:load_instrument_images}.
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/load_instrument_images_main_menu.PNG}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/load_instrument_images_gis_view.PNG}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/projected_images_settings_1.PNG}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/projected_images_settings_2.PNG}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/AnnotationEllipse1.PNG}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./pics/AnnotationEllipse2.PNG}
    \end{subfigure}
