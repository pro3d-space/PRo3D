...
% ********* Links into the online documentation *******
% The repository carries one markdown page per feature in the docs/ folder.
% \onlinedoc{Page.md}{link text} links to such a page on GitHub,
% \furtherreading{...} typesets a "Further reading" note containing such links.
\newcommand{\onlinedoc}[2]{\href{https://github.com/pro3d-space/PRo3D/blob/main/docs/#1}{#2}}
\newcommand{\docsfolder}[1]{\href{https://github.com/pro3d-space/PRo3D/tree/main/docs}{#1}}
\newcommand{\furtherreading}[1]{%
	\par\smallskip\noindent
	\textit{Further reading:} #1%
	\par\smallskip}
...
\begin{titlepage}
	...
	{\large Authors: \par 
	Thomas Ortner, Laura Fritz, Rebecca Nowak, Harald Steinlechner, Sophie Pichler}
	\vfill
	% Bottom of the page
