//a9f9cb59-7696-d7f0-31d7-41d873ade479
//0f354b3e-43c5-5ffe-b32e-f693b51ffa22
...
type AdaptiveGeologicSurface(value : GeologicSurface) =
    ...
    let _transparency_ = Aardvark.UI.AdaptiveNumericInput(value.transparency)
...
module GeologicSurfaceLenses = 
    type GeologicSurface with
        ...
        static member transparency_ = ((fun (self : GeologicSurface) -> self.transparency), (fun (value : Aardvark.UI.NumericInput) (self : GeologicSurface) -> { self with transparency = value }))
        static member thickness_ = ((fun (self : GeologicSurface) -> self.thickness), (fun (value : Aardvark.UI.NumericInput) (self : GeologicSurface) -> { self with thickness = value }))
