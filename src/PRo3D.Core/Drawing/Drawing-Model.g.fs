//c9ff3a43-eed7-7164-a893-9ae3279a5b11
//798fa62f-32c5-94fe-9a9c-e5b0552ce616
...
type AdaptiveDrawingModel(value : DrawingModel) =
    ...
    let _samplingAmount_ = Aardvark.UI.AdaptiveNumericInput(value.samplingAmount)
...
module DrawingModelLenses = 
    type DrawingModel with
        ...
        static member thickness_ = ((fun (self : DrawingModel) -> self.thickness), (fun (value : Aardvark.UI.NumericInput) (self : DrawingModel) -> { self with thickness = value }))
        static member samplingAmount_ = ((fun (self : DrawingModel) -> self.samplingAmount), (fun (value : Aardvark.UI.NumericInput) (self : DrawingModel) -> { self with samplingAmount = value }))
