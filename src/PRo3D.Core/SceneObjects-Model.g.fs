//fa1a7b6d-b094-6021-006b-0e9cf000e388
//ecf64e6c-2876-bd13-f353-b97e5ed2a009
...
module SceneObjectLenses = 
    type SceneObject with
        ...
        static member scaling_ = ((fun (self : SceneObject) -> self.scaling), (fun (value : Aardvark.UI.NumericInput) (self : SceneObject) -> { self with scaling = value }))
