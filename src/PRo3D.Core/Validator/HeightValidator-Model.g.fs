//f873c6f3-92e0-f38e-8069-7f6131573cd6
//081e27ea-e13b-e7dc-2c45-7b7155519f83
...
type AdaptiveValidator(value : Validator) =
    ...
    let _inclination_ = Aardvark.UI.AdaptiveNumericInput(value.inclination)
...
module ValidatorLenses = 
    type Validator with
        ...
        static member inclination_ = ((fun (self : Validator) -> self.inclination), (fun (value : Aardvark.UI.NumericInput) (self : Validator) -> { self with inclination = value }))
