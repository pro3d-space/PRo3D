//f46a455d-d47f-b065-e7f1-384d52161b0f
//1f7ec80a-a614-bacc-acf4-b9da52f986d9
...
module InstrumentLenses = 
    type Instrument with
        ...
        static member focal_ = ((fun (self : Instrument) -> self.focal), (fun (value : Aardvark.UI.NumericInput) (self : Instrument) -> { self with focal = value }))
...
type AdaptiveAxis(value : Axis) =
    ...
    let _index_ = FSharp.Data.Adaptive.cval(value.index)
    let _angle_ = Aardvark.UI.AdaptiveNumericInput(value.angle)
...
module AxisLenses = 
    type Axis with
        ...
        static member angle_ = ((fun (self : Axis) -> self.angle), (fun (value : Aardvark.UI.NumericInput) (self : Axis) -> { self with angle = value }))
...
type AdaptiveViewPlan(value : ViewPlan) =
    ...
    let _currentAngle_ = Aardvark.UI.AdaptiveNumericInput(value.currentAngle)
    let mutable __value = value
    let __adaptive = FSharp.Data.Adaptive.AVal.custom((fun (token : FSharp.Data.Adaptive.AdaptiveToken) -> __value))
...
module ViewPlanLenses = 
    type ViewPlan with
        ...
        static member currentAngle_ = ((fun (self : ViewPlan) -> self.currentAngle), (fun (value : Aardvark.UI.NumericInput) (self : ViewPlan) -> { self with currentAngle = value }))
[<System.Diagnostics.CodeAnalysis.SuppressMessage("NameConventions", "*")>]
type AdaptiveViewPlanModel(value : ViewPlanModel) =
    ...
    let _selectedViewPlan_ =
        let inline __arg2 (o : System.Object) (v : ViewPlan) =
            (unbox<AdaptiveViewPlan> o).Update(v)
            o
        let inline __arg5 (o : System.Object) (v : ViewPlan) =
            (unbox<AdaptiveViewPlan> o).Update(v)
            o
        Adaptify.FSharp.Core.AdaptiveOption<PRo3D.SimulatedViews.ViewPlan, PRo3D.SimulatedViews.AdaptiveViewPlan, PRo3D.SimulatedViews.AdaptiveViewPlan>(value.selectedViewPlan, (fun (v : ViewPlan) -> AdaptiveViewPlan(v) :> System.Object), __arg2, (fun (o : System.Object) -> unbox<AdaptiveViewPlan> o), (fun (v : ViewPlan) -> AdaptiveViewPlan(v) :> System.Object), __arg5, (fun (o : System.Object) -> unbox<AdaptiveViewPlan> o))
    ...
    member __.Update(value : ViewPlanModel) =
        if Microsoft.FSharp.Core.Operators.not((FSharp.Data.Adaptive.ShallowEqualityComparer<ViewPlanModel>.ShallowEquals(value, __value))) then
            ...
            _selectedViewPlan_.Update(value.selectedViewPlan)
    ...
    member __.selectedViewPlan = _selectedViewPlan_ :> FSharp.Data.Adaptive.aval<Adaptify.FSharp.Core.AdaptiveOptionCase<ViewPlan, AdaptiveViewPlan, AdaptiveViewPlan>>
...
module ViewPlanModelLenses = 
    type ViewPlanModel with
        ...
        static member selectedViewPlan_ = ((fun (self : ViewPlanModel) -> self.selectedViewPlan), (fun (value : Microsoft.FSharp.Core.Option<ViewPlan>) (self : ViewPlanModel) -> { self with selectedViewPlan = value }))
