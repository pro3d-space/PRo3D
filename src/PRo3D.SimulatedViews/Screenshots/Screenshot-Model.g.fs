//c4d08dd3-d54d-0dd1-73e5-417e0f9c16b1
//e4b11707-7858-dd5e-1a56-426f18041c12
...
type AdaptiveScreenshotModel(value : ScreenshotModel) =
    ...
    let _height_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.height)
...
module ScreenshotModelLenses = 
    type ScreenshotModel with
        ...
        static member width_ = ((fun (self : ScreenshotModel) -> self.width), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : ScreenshotModel) -> { self with width = value }))
        static member height_ = ((fun (self : ScreenshotModel) -> self.height), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : ScreenshotModel) -> { self with height = value }))
