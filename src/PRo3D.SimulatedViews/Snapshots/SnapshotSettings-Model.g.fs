//b97976e3-c509-29ec-8b53-95e506a1c6e2
//a6c158bf-b7ff-8aee-980b-651324f3479a
...
type AdaptiveSnapshotSettings(value : SnapshotSettings) =
    ...
    let _numSnapshots_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.numSnapshots)
    let _fieldOfView_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.fieldOfView)
...
module SnapshotSettingsLenses = 
    type SnapshotSettings with
        ...
        static member numSnapshots_ = ((fun (self : SnapshotSettings) -> self.numSnapshots), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : SnapshotSettings) -> { self with numSnapshots = value }))
        static member fieldOfView_ = ((fun (self : SnapshotSettings) -> self.fieldOfView), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : SnapshotSettings) -> { self with fieldOfView = value }))
