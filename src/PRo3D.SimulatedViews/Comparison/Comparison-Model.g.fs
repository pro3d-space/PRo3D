...
type AdaptiveComparisonApp(value : ComparisonApp) =
    ...
    let _initialAreaSize_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.initialAreaSize)
    let _pointSizeFactor_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.pointSizeFactor)
...
module ComparisonAppLenses = 
    type ComparisonApp with
        ...
        static member initialAreaSize_ = ((fun (self : ComparisonApp) -> self.initialAreaSize), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : ComparisonApp) -> { self with initialAreaSize = value }))
        static member pointSizeFactor_ = ((fun (self : ComparisonApp) -> self.pointSizeFactor), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : ComparisonApp) -> { self with pointSizeFactor = value }))
