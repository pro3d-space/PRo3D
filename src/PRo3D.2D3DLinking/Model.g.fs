//d40d3cc0-d32e-d2ca-f586-dedd4d916f22
//f855bc89-640e-19e3-c7a3-172a522c51f4
...
module ModelLenses = 
    type Model with
        ...
        static member patchHierarchies_ = ((fun (self : Model) -> self.patchHierarchies), (fun (value : Microsoft.FSharp.Collections.list<Aardvark.Data.Opc.PatchHierarchy>) (self : Model) -> { self with patchHierarchies = value }))
