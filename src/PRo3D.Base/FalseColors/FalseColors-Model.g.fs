//ff08ce1b-3b6b-6f5e-ae7d-273bc2a28683
...
type AdaptiveFalseColorsModel(value : FalseColorsModel) =
    ...
    let _lowerBound_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.lowerBound)
    let _upperBound_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.upperBound)
    let _interval_ = Aardvark.UI.Primitives.AdaptiveNumericInput(value.interval)
...
module FalseColorsModelLenses = 
    type FalseColorsModel with
        ...
        static member lowerBound_ = ((fun (self : FalseColorsModel) -> self.lowerBound), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : FalseColorsModel) -> { self with lowerBound = value }))
        static member upperBound_ = ((fun (self : FalseColorsModel) -> self.upperBound), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : FalseColorsModel) -> { self with upperBound = value }))
        static member interval_ = ((fun (self : FalseColorsModel) -> self.interval), (fun (value : Aardvark.UI.Primitives.NumericInput) (self : FalseColorsModel) -> { self with interval = value }))
