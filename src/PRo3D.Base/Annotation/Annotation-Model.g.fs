//c1470929-e14d-40dc-f289-1c11673b9305
//68b5b88c-9006-3214-c421-c5b80d44c0a3
...
type AdaptiveAnnotation(value : Annotation) =
    ...
    let _manualDipAngle_ = Aardvark.UI.AdaptiveNumericInput(value.manualDipAngle)
    let _manualDipAzimuth_ = Aardvark.UI.AdaptiveNumericInput(value.manualDipAzimuth)
...
module AnnotationLenses = 
    type Annotation with
        ...
        static member thickness_ = ((fun (self : Annotation) -> self.thickness), (fun (value : Aardvark.UI.NumericInput) (self : Annotation) -> { self with thickness = value }))
        ...
        static member textsize_ = ((fun (self : Annotation) -> self.textsize), (fun (value : Aardvark.UI.NumericInput) (self : Annotation) -> { self with textsize = value }))
        ...
        static member manualDipAngle_ = ((fun (self : Annotation) -> self.manualDipAngle), (fun (value : Aardvark.UI.NumericInput) (self : Annotation) -> { self with manualDipAngle = value }))
        static member manualDipAzimuth_ = ((fun (self : Annotation) -> self.manualDipAzimuth), (fun (value : Aardvark.UI.NumericInput) (self : Annotation) -> { self with manualDipAzimuth = value }))
