...
let private propertyTests =
    testList "Annotation property mutations" [
        ...
        test "TC-5.1 ToggleVisible hides a visible annotation" {
            let ann  = baseAnn ()
        ...
        test "TC-5.1 ToggleVisible twice restores visibility" {
            let ann  = baseAnn ()
            let ann' =
                ann
        ...
        test "TC-5.1 ToggleShowDns flips showDns on DnS annotation" {
            let ann =
        ...
        test "TC-5.3 ToggleShowText flips showText" {
            let ann  = baseAnn ()
