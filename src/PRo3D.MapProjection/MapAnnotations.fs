...
module MapAnnotations =
    ...
    let mapWithAnnotations (cfg : OpcSg.Config) (view : MapSg.MapView) (surfaces : aset<MapSg.MapSurface>) (inputs : AnnotationInputs) : ISg =
        Sg.ofList [ MapSg.map cfg view surfaces; sg inputs view ]
